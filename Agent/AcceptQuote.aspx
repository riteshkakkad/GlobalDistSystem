<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeFile="AcceptQuote.aspx.cs" Inherits="Agent_AcceptQuote" %>
...
<body>
    ...
    <div style="width: 150px; text-align: center; margin-left: auto; margin-right: auto;
        ...
        <a href="AcceptQuote.aspx?bidid=<%= ob.BidID %>&acceptquote=1" style="font-size: 12px;
            color: White" class="redlinkbutton">Accept Quote</a></div>
</body>
</html>
