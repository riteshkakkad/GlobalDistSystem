<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowEmptyLegBids.aspx.cs"
    Inherits="Admin_ShowEmptyLegBids" %>
...
<table class="bluetable" style="width: 450px; margin-bottom: 15px;">
    ...
    <tr>
        <td>
            ...
            <br />
            Email:
            <%= (el.AcceptedOffer.IsAgent) ? el.AcceptedOffer.Agent.Email : el.AcceptedOffer.Customer.Email%>
            <br />
            Phone No:
            <%= (el.AcceptedOffer.IsAgent) ? el.AcceptedOffer.Agent.ContactNo : el.AcceptedOffer.Customer.ContactNo %>
        </td>
        <td>
            Bid Amount :<br />
...
<table class="bluetable" style="width: 450px">
    ...
    <tr>
        <td>
            ...
            <br />
            Email:
            <%= (elo.IsAgent) ? elo.Agent.Email : elo.Customer.Email %>
            <br />
            Phone No:
            <%= (elo.IsAgent) ? elo.Agent.ContactNo : elo.Customer.ContactNo %>
        </td>
        <td>
