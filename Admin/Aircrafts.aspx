<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMaster.master"
    CodeFile="Aircrafts.aspx.cs" Inherits="Aircrafts" %>
...
<asp:Content ContentPlaceHolderID="scriptholder" runat="server">
    ...
    addalternaterowcolors();
         ...
         $("#addaircraftform").submit(function(){
            ...
            'data': $("#addaircraftform").serialize()+"&opid="+$("#opid").val()+"&aircraftadd=1",
            'dataType': 'json',
            'type': 'POST',
            'beforeSend':function(){
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentholder" runat="server">
    ...
    <% Operator op = OperatorDAO.FindOperatorByID(Int64.Parse(Request.Params.Get("oid"))); %>
    <div style="padding:20px;font-size:14px;font-weight:bold"><%= op.CompanyName %></div>
    <input type="hidden" id="opid" value="<%= Request.Params.Get("oid") %>" />
    <table cellpadding="10" id="aircraftlist" class="bluetable" style="text-align: center;
        ...
        <tr class="aircraft">
            ...
            <td>
                <div class="editcurr">
                    <%= (a.Currency!=null)? a.Currency.FullName+"("+a.Currency.ID+")" : ""%>
                </div>
            ...
            <td>
                <div style="margin-bottom: 10px; font-size: 12px;">
                    <a href="Photos.aspx?aid=<%= a.AircraftId %>&keepThis=true&TB_iframe=true&height=500&width=400"
                        class="thickbox" style="color: #707070">Add/Show Photos</a></div>
