<%@ Page Language="C#" MasterPageFile="~/CharterTemplate.master" AutoEventWireup="true"
    CodeFile="Settings.aspx.cs" Inherits="Customer_Settings" Title="Untitled Page" %>
    ...
    <form id="profileform">
        <table class="bluetable" style="margin: 20px; margin-left: auto; margin-right: auto;
            ...
            <tr>
                ...
                <td>
                    <input id="Name" name="Name" type="text" class="required" value="<%= c.Name %>" />
                </td>
            </tr>
            <tr>
                <th valign="top">
                ...
                <td>
                    <input name="CompanyName" type="text" value="<%= c.CompanyName %>" />
                </td>
            </tr>
            <tr>
                <th valign="top">
                ...
                <td>
                    <input id="ContactNo" name="ContactNo" type="text" class="required" value="<%= c.ContactNo %>" />
                </td>
            </tr>
            <tr>
                <th valign="top">
                ...
                <td>
                    <textarea id="Address" name="Address" cols="20" class="required"><%= c.Address %></textarea>
                </td>
            </tr>
            <tr>
                <th valign="top">
                ...
                <td>
                    <select name="country">
                        <%  foreach (Country cr in OperatorDAO.GetCountries())
                            {

                                Boolean temp = false;
                                if (c.Country == cr.CountryID)
                                    temp = true;
                        %>
                        <option value="<%= cr.CountryID %>" <%= (temp)?"selected" :"" %>>
                            <%= cr.FullName%>
                        </option>
                        <%
            ...
            <tr>
                ...
                <td>
                    <input id="AlternateEmail" name="AlternateEmail" type="text" class="email" value="<%= c.Email1 %>" />
                </td>
            </tr>
            <tr>
                <th valign="top">
                ...
                <td>
                    <input id="AlternateContactNo" name="AlternateContactNo" type="text" value="<%= c.ContactNo1 %>" />
                </td>
            </tr>
            <tr>
                <th colspan="2">
