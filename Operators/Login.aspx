<%@ Page Language="C#" MasterPageFile="~/CharterTemplate.master" AutoEventWireup="true"
    CodeFile="Login.aspx.cs" Inherits="Operators_Login" Title="Untitled Page" %>
    ...
    <script language="C#" runat="server">
        void Login_Click(Object Src, EventArgs E)
        {
            ...
            try
            {
                ...
                Operator o = OperatorDAO.VerifyOperator(userName.Text, txtPwd.Text);
                if (o != null)
                {
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentholder" runat="Server">
    <form id="Form1" runat="server" style="margin-left: 10px; margin-right: 20px; width: 400px;float:left;margin-top:30px;">
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="btnLogin" Text="Login" OnClick="Login_Click" runat="Server" CssClass="buttons"
                        Width="100px" /><asp:Label ID="lblLoginMsg" CssClass="error" runat="server" />
             ...
             $.ajax({
                    ...
                    'data': "email="+$("input[name=forgotemail]").val()+"&operatorforgotpassword=1",
                    'dataType': 'text',
                    'type': 'POST',
                    'beforeSend':function(){
    ...
    <div style="width: 400px;margin-top:30px;
        ...
        <div class="airnetz-lists" style="margin-top: 15px;">
            <ul style="width: 300px; margin-left: auto; margin-right: auto; text-align: left;">
                <li style="margin: 10px">Join our network of over 2000 operators and fast growing number
                    of customers</li>
                <li style="margin: 10px">Manage Aircrafts</li>
                <li style="margin: 10px">Manage Charter Requests</li>
                <li style="margin: 10px">Manage bids</li>
            </ul>
        </div>
        <div style="text-align: center; margin-top: 10px;">
            <a href="../OperatorRegister.aspx" class="redlinkbutton">OPERATOR SIGN UP</a>
        </div>
    </div>
    <div class="clear"></div>
</asp:Content>
